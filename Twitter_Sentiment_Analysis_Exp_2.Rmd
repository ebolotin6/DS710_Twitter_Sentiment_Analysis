...
setwd('Twitter_Sentiment_Analyzer/Samples_Round_2/')
...
We notice that for the fitness group, ~88% of tweets are equal to or above 0 (neutral) sentiment. For the media group, this number is ~85%. The conclusion for both groups is that tweets are overwhelmingly neutral and/or positive in sentiment.
