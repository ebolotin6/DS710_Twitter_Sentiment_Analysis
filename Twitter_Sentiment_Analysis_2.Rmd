...
To answer this question, we have performed sentiment analysis on Twitter data. Two sample groups have been collected (using Python and Twitter's API), cleaned, and sentiment calculated using the methdology described in the project summary. These sample groups of tweets are stored in distinct CSV files. They are ready to be read-into R. Let's begin the statistical analysis.
